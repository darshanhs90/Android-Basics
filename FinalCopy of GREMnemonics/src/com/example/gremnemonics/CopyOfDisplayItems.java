...
public class CopyOfDisplayItems extends Activity implements OnQueryTextListener, OnItemClickListener, OnClickListener{
	String ListValue;
	int rowValue=0;
	String QueryValue;
	...
	ImageButton ibnHome,ibnBlue,ibnRed,ibnOrangeRed,ibnYellow,ibnGreenYellow,ibnGreen;
	View v;
	String b[];
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.copyofdisplayitems);
		...
		ibnBlue=(ImageButton) findViewById(R.id.ibnBlue);
		ibnRed=(ImageButton)findViewById(R.id.ibnRed);
		ibnOrangeRed=(ImageButton)findViewById(R.id.ibnOrangeRed);
		ibnGreen=(ImageButton)findViewById(R.id.ibnGreen);
		ibnGreenYellow=(ImageButton)findViewById(R.id.ibnGreenYellow);
		ibnYellow=(ImageButton)findViewById(R.id.ibnYellow);
		ibnBlue.setOnClickListener(this);
		ibnRed.setOnClickListener(this);
		ibnOrangeRed.setOnClickListener(this);
		ibnYellow.setOnClickListener(this);
		ibnGreen.setOnClickListener(this);
		ibnGreenYellow.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.ibnListIcon:
			Intent listIcon=new Intent(this,CopyOfDisplayItems.class);
		...
		case R.id.ibnBlue:
			...
			for(int i=0;i<nameValues.size();i++){ 
				db.open();
				if(db.getColor(nameValues.get(i)).contentEquals("BLUE"))
				{
					b[i]=nameValues.get(i);
					j++;
				}
			...
			adapter=new customAdapter(this,R.layout.rowlayout, c);
			lvDynamicWords=(ListView) findViewById(R.id.lvDynamicWords);
			lvDynamicWords.setAdapter(adapter);
			this.v.invalidate();
			break;
		case R.id.ibnRed:
			...
			for(int i=0;i<nameValues.size();i++){ 
				db.open();
				if(db.getColor(nameValues.get(i)).contentEquals("RED"))
				{
					b[i]=nameValues.get(i);
					j++;
				}
			...
			String c1[]=new String[j];
			System.out.println("c1 value is "+c1.length);
			
			for(int i=0;i<j;i++){ 
				c1[i]=b[i];
			}
			adapter=new customAdapter(this,R.layout.rowlayout, c1);
			lvDynamicWords=(ListView) findViewById(R.id.lvDynamicWords);
			lvDynamicWords.setAdapter(adapter);
			this.v.invalidate();
			break;
		case R.id.ibnOrangeRed:
			b = new String[nameValues.size()];
			j=0;
			for(int i=0;i<nameValues.size();i++){ 
				db.open();
				if(db.getColor(nameValues.get(i)).contentEquals("ORANGERED"))
				{
					b[i]=nameValues.get(i);
					j++;
				}
			...
			String c2[]=new String[j];
			for(int i=0;i<j;i++){ 
				c2[i]=b[i];
			}
			adapter=new customAdapter(this,R.layout.rowlayout, c2);
			lvDynamicWords=(ListView) findViewById(R.id.lvDynamicWords);
			lvDynamicWords.setAdapter(adapter);
			this.v.invalidate();
			break;
		case R.id.ibnYellow:
			...
			for(int i=0;i<nameValues.size();i++){ 
				db.open();
				if(db.getColor(nameValues.get(i)).contentEquals("YELLOW"))
				{
					b[i]=nameValues.get(i);
					j++;
				}
			...
			String c3[]=new String[j];
			for(int i=0;i<j;i++){ 
				c3[i]=b[i];
			}
			adapter=new customAdapter(this,R.layout.rowlayout, c3);
			lvDynamicWords=(ListView) findViewById(R.id.lvDynamicWords);
			lvDynamicWords.setAdapter(adapter);
			this.v.invalidate();
			break;
		case R.id.ibnGreen:
			...
			for(int i=0;i<nameValues.size();i++){ 
				db.open();
				if(db.getColor(nameValues.get(i)).contentEquals("GREEN"))
				{
					b[i]=nameValues.get(i);
					j++;
				}
			...
			String c4[]=new String[j];
			for(int i=0;i<j;i++){ 
				c4[i]=b[i];
			}
			adapter=new customAdapter(this,R.layout.rowlayout, c4);
			lvDynamicWords=(ListView) findViewById(R.id.lvDynamicWords);
			lvDynamicWords.setAdapter(adapter);
			this.v.invalidate();
			break;
		case R.id.ibnGreenYellow:
			b = new String[nameValues.size()];
			j=0;
			for(int i=0;i<nameValues.size();i++){ 
				db.open();
				if(db.getColor(nameValues.get(i)).contentEquals("GREENYELLOW"))
				{
					b[i]=nameValues.get(i);
					j++;
				}
			...
			String c5[]=new String[j];
			for(int i=0;i<j;i++){ 
				c5[i]=b[i];
			}
			adapter=new customAdapter(this,R.layout.rowlayout, c5);
			lvDynamicWords=(ListView) findViewById(R.id.lvDynamicWords);
			lvDynamicWords.setAdapter(adapter);
			this.v.invalidate();
			break;
