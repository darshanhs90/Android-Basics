...
public class tempDisplay extends Activity implements OnClickListener {
	ViewFlipper flipper;   
	int clickCount=0;
	...
	public void onClick(View v) {
		...
		case R.id.ibnForward:
			...
			colorSetter();
			tvWordName.setText(nameValues.get(rowcounter));
			tvMeaningName.setText(nameValues.get(rowcounter));
			tvMnemonicName.setText(nameValues.get(rowcounter));
			break;
	...
	private void countCheck() {
		//if no mnemonic,skip the mnemonic layout
		if(clickCount%3==0){
